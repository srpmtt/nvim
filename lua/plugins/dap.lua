return {
  ...
  config = function()
    ...
    dap.configurations.sh = project_dap
      and project_dap.dap.configurations.sh {
        {
          type = "bashdb",
          request = "launch",
          name = "launch",
    ...
    -- C
    dap.adapters.codelldb = project_dap
      and project_dap.dap.adapters.codelldb {
        type = "executable",
        command = vim.fn.stdpath "data" .. "/mason/packages/codelldb/codelldb",
      }

    dap.configurations.c = project_dap
      and project_dap.dap.configurations.c {
        {
          name = "launch",
          type = "codelldb",
          request = "launch",
    ...
    -- JAVASCRIPT
    dap.adapters["pwa-node"] = project_dap
      and project_dap.dap.adapters["pwa-node"] {
        type = "server",
        host = "localhost",
        port = "${port}",
        executable = {
    ...
    dap.configurations.javascript = project_dap
      and project_dap.dap.configurations.javascript {
        {
          type = "pwa-node",
          request = "launch",
          name = "launch",
    ...
    -- LUA
    dap.adapters["local-lua"] = project_dap
      and project_dap.dap.adapters["local-lua"] {
        type = "executable",
        command = "node",
        args = {
    ...
    dap.configurations.lua = project_dap
      and project_dap.dap.configurations.lua {
        {
          name = "launch",
          type = "local-lua",
          request = "launch",
    ...
    dap.configurations.rust = project_dap
      and project_dap.dap.configurations.rust {
        {
          name = "launch",
          type = "codelldb",
          request = "launch",
