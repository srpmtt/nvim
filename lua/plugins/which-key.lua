...
keymap('v', 's', [[:<C-u>lua custom_surround(vim.fn.input('surround with: '))<cr>]],
...
local mappings = {
  ...
  { "<leader>bb", "<cmd>JABSOpen<cr>",                                                          desc = "buffers", },
  { "<leader>bn", "<cmd>enew<cr>",                                                              desc = "new buffer", },
  { "<leader>bv", "<cmd>vnew<cr>",                                                              desc = "new buffer vertical", },
  ...
  { "<leader>ll", "glj",                                                                        desc = "log", },
  { "<leader>lq", "<cmd>Telescope diagnostics<cr>",                                             desc = "workspace diagnostics", },
  ...
  { "<leader>nc", "<cmd>e $MYVIMRC<cr>",                                                        desc = "neovim configuration", },
  { "<leader>nl", "<cmd>Lazy<cr>",                                                              desc = "lazy", },
  { "<leader>nm", "<cmd>Mason<cr>",                                                             desc = "mason", },
  { "<leader>nt", "<cmd>TSUpdate<cr>",                                                          desc = "treesitter update", },
  ...
  --misc
  { "<leader>q",  group = "misc", },
  { "<leader>qc", "<cmd>ColorizerToggle<cr>",                                                   desc = "toggle colorizer", },
  { "<leader>qk", "<cmd>Telescope keymaps<cr>",                                                 desc = "keymaps", },
  { "<leader>qm", "<cmd>MarkdownPreview<cr>",                                                   desc = "markdown preview", },
  ...
  { "<leader>st", "<cmd>vsplit | terminal<cr>i",                                                desc = "split terminal", },
